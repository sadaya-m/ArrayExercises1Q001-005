...
{  // begin class
    ...
    // ***** get input *****
        ...
        string2 = JOptionPane.showInputDialog("Select the position of the number you want to change (first position = 0)");    //ask input
    ...
    // ***** processing *****
        ...
        while(n!=-1){
            ...
            n = Integer.parseInt(JOptionPane.showInputDialog("Select the position of the number you want to change"));
        }//end while loop
